...
search_task_sys_msg = (
    "You evolve the documentation prompt string inside initial.py (DOC_PROMPT). "
    "Mutations should improve clarity, coverage, and accuracy for generating docs "
    "that help an LLM produce patches matching real Zed PRs."
)

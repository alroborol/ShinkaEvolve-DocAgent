...
def sample_model_kwargs(
    ...
    elif is_ollama_model_name(kwargs_dict["model_name"]):
        # Ollama expects num_predict for output control, mirroring max_tokens here.
        kwargs_dict["max_tokens"] = random.choice(max_tokens)
...
def query(
    ...
    **kwargs,
    ...
    if is_ollama_model_name(requested_model_name) or is_ollama_model_name(model_name):
